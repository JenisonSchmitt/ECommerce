            ...
            <body>
                  <section class='scrollspy-section bg-personality_14 padding-xlarge_1 center' >
                        <div class='btn-wrap'>
                              ...
                              <br>
                              <br>
                              <h3 class='paragrafo_5'>Cupom Cadastrado</h3>
                        </div>
                        <br>
                        <div class='btn-wrap'>
                              <a href='https://www.lujinhadeluxo.com.br/admin/CupomCadastrar.html' class='btn btn-accent btn-xlarge btn-rounded'>Cadastrar mais Cupons</a>
                        </div>
                  </section>
            ...
            <body>
                  <section class='scrollspy-section bg-personality_14 padding-xlarge_1 center' >
                        <div class='btn-wrap'>
                              ...
                              <br>
                              <br>
                              <h3 class='paragrafo_5'>Cumpom não Cadastrado, por favor, volte e verifique os dados</h3>
                        </div>
                        <br>
                        <div class='btn-wrap'>
                              <a href='https://www.lujinhadeluxo.com.br/admin/CupomCadastrar.html' class='btn btn-accent btn-xlarge btn-rounded'>Cadastrar novamente</a>
                        </div>
                  </section>
                  <script src='js/jquery-1.11.0.min.js'></script>
                  <script src='js/ui-easing.js'></script>
